...
export declare function translateDrawCurrentStroke(context: canvasContext, model: model, translatePosition: point, strokes: Graphics | Graphics[]): void;
...
export declare function drawCurrentStroke(context: canvasContext, model: model, stroker: Graphics | Graphics[]): void;
